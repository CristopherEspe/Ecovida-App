package org.ecovida.order.service.config;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/orders/create/{userId}").authenticated()
                        .requestMatchers("/orders/{orderId}").authenticated()
                        .requestMatchers("/orders/{orderId}/status").hasRole("ADMIN")
                        .requestMatchers("/orders/{orderId}/ship").hasRole("ADMIN")
